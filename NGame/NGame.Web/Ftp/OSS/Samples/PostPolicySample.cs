    ...
    public static class PostPolicySample
    {
        ...
        public static void GenPostPolicy(string bucketName)
        {
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Generated post policy: {0}", postPolicy);

                var requestUri = BuildRequestUri(endpoint, bucketName);
                UnityEngine.Debug.LogFormat("RequestUri:" + requestUri);
                ...
                {
                    UnityEngine.Debug.LogFormat("Post object succeed!");
                }
            }
