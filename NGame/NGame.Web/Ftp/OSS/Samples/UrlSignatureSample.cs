    ...
    public static class UrlSignatureSample
    {
        ...
        public static void GetObjectBySignedUrlWithWebRequest(string bucketName, string key)
        {
            try
            {
                ...
                try
                {
                    ...
                    UnityEngine.Debug.LogFormat("Get object by signatrue succeeded.");
                }
                catch (Exception ex)
                {
                    UnityEngine.Debug.LogFormat("ex : " + ex.Message);
                }
            }
        ...
        public static void PutLocalFileBySignedUrl(string bucketName, string key)
        {
            ...
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Put object by signatrue succeeded.");
            }
            catch (OssException ex)
            {
                UnityEngine.Debug.LogFormat("Failed with error code: {0}; Error info: {1}. \nRequestID:{2}\tHostID:{3}", 
