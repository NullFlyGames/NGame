    ...
    public static class ResumbaleSample
    {
        ...
        public static void ResumableDownloadObject(string bucketName)
        {
            ...
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Resumable download object:{0} succeeded", key);
            }
            catch (OssException ex)
            {
                UnityEngine.Debug.LogFormat("Failed with error code: {0}; Error info: {1}. \nRequestID:{2}\tHostID:{3}",
                                               ...
                                               string destBucketName, string destKey)
        {
            ...
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Resumable copy new object:{0} succeeded", request.DestinationKey);
            }
            catch (OssException ex)
            {
                UnityEngine.Debug.LogFormat("Failed with error code: {0}; Error info: {1}. \nRequestID:{2}\tHostID:{3}",
