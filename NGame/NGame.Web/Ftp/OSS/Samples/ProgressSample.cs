    ...
    public static class ProgressSample
    {
        ...
        public static void PutObjectProgress(string bucketName)
        {
            ...
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Put object:{0} succeeded", key);
            }
        ...
        public static void AppendObjectProgress(string bucketName)
        {
            ...
            try
            {
                using (var fs = File.Open(fileToUpload, FileMode.Open))
                {
                    ...
                    UnityEngine.Debug.LogFormat("Append object succeeded, next append position:{0}", position);
                }
            }
            catch (OssException ex)
            {
        ...
        public static void MultipartUploadProgress(string bucketName)
        {
            ...
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Multipart upload object:{0} succeeded", key);
            }
            catch (OssException ex)
            {
                UnityEngine.Debug.LogFormat("Failed with error code: {0}; Error info: {1}. \nRequestID:{2}\tHostID:{3}",
        ...
        public static void ResumableUploadProgress(string bucketName)
        {
            ...
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Resumable upload object:{0} succeeded", key);
            }
            catch (OssException ex)
            {
                UnityEngine.Debug.LogFormat("Failed with error code: {0}; Error info: {1}. \nRequestID:{2}\tHostID:{3}",
        ...
        public static void GetObjectProgress(string bucketName)
        {
            ...
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Get object:{0} succeeded", key);
            }
            catch (OssException ex)
            {
                UnityEngine.Debug.LogFormat("Failed with error code: {0}; Error info: {1}. \nRequestID:{2}\tHostID:{3}",
        ...
        {
            UnityEngine.Debug.LogFormat("ProgressCallback - TotalBytes:{0}, TransferredBytes:{1}, IncrementTransferred:{2}",
        ...
        private static void PutObjectCallback(IAsyncResult ar)
        {
            try
            {
                ...
                UnityEngine.Debug.LogFormat(ar.AsyncState as string);
            }
            catch (Exception ex)
            {
        ...
        private static void AppendObjectCallback(IAsyncResult ar)
        {
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Append object succeeded, next append position:{0}", result.NextAppendPosition);
                UnityEngine.Debug.LogFormat(ar.AsyncState as string);
            }
            catch (Exception ex)
            {
