    ...
    public static class CNameSample
    {
        ...
        public static void PutObject(string bucketName) 
        {
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Put object with CNAME succeeded");
            }
        ...
        public static void DeleteObject(string bucketName)
        {
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Delete object with CNAME succeeded");
            }
            catch (OssException ex)
            {
                UnityEngine.Debug.LogFormat("Failed with error code: {0}; Error info: {1}. \nRequestID:{2}\tHostID:{3}",
        ...
        public static void SetBucketAcl(string bucketName)
        {
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Set bucket acl with CNAME succeeded");
            }
            catch (OssException ex)
            {
                UnityEngine.Debug.LogFormat("Failed with error code: {0}; Error info: {1}. \nRequestID:{2}\tHostID:{3}",
