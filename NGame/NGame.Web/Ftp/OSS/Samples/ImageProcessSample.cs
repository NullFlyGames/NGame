    ...
    public static class ImageProcessSample
    {
        ...
        public static void ResizeImage(string bucketName)
        {
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Get Object:{0} with process:{1} succeeded ", key, process);
            }
        ...
        public static void GenerateIamgeUri(string bucketName)
        {
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Generate Presigned Uri:{0} with process:{1} succeeded ", uri, process);
            }
            catch (OssException ex)
            {
                UnityEngine.Debug.LogFormat("Failed with error code: {0}; Error info: {1}. \nRequestID:{2}\tHostID:{3}",
