    ...
    public static class ListObjectsSample
    {
        ...
        public static void SimpleListObjects(string bucketName)
        {
            try
            {
                ...
                UnityEngine.Debug.LogFormat("List objects of bucket:{0} succeeded ", bucketName);
                foreach (var summary in result.ObjectSummaries)
                {
                    UnityEngine.Debug.LogFormat(summary.Key);
                }

                UnityEngine.Debug.LogFormat("List objects of bucket:{0} succeeded, is list all objects ? {1}", bucketName, !result.IsTruncated);
            }
        ...
        private static void ListObjectCallback(IAsyncResult ar)
        {
            try
            {
                ...
                UnityEngine.Debug.LogFormat("List objects of bucket:{0} succeeded ", result.BucketName);
