    ...
    public static class UploadCallbackSample
    {
        ...
        public static void PutObjectProgress(string bucketName)
        {
            ...
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Put object:{0} succeeded, callback response content:{1}", key, responseContent);
            }
        ...
        public static void MultipartUploadProgress(string bucketName)
        {
            ...
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Multipart upload object:{0} succeeded, callback response content:{1}", key, responseContent);
            }
            catch (OssException ex)
            {
                UnityEngine.Debug.LogFormat("Failed with error code: {0}; Error info: {1}. \nRequestID:{2}\tHostID:{3}",
        ...
        public static void ResumableUploadProgress(string bucketName)
        {
            ...
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Resumable upload object:{0} succeeded, callback response content:{1}", key, responseContent);
            }
            catch (OssException ex)
            {
                UnityEngine.Debug.LogFormat("Failed with error code: {0}; Error info: {1}. \nRequestID:{2}\tHostID:{3}",
        ...
        private static void PutObjectCallback(IAsyncResult ar)
        {
            try
            {
                ...
                UnityEngine.Debug.LogFormat("Put object succeeded, callback response content:{0}", GetCallbackResponse(result));
