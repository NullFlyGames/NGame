...
using ExecutionContext = NClient.OSS.Common.Communication.ExecutionContext;
using ICredentials = NClient.OSS.Common.Authentication.ICredentials;
    ...
    public class OssClient : IOss
    {
        ...
        public OssClient(Uri endpoint, ICredentialsProvider credsProvider, ClientConfiguration configuration)
        {
            ...
            if (credsProvider == null)
                throw new ArgumentException("", "credsProvider");
        ...
        public bool DoesBucketExist(string bucketName)
        {
            ...
            if (!OssUtils.IsBucketNameValid(bucketName))
                throw new ArgumentException("Invalid bucket name. The bucket naming rules:", "bucketName");
