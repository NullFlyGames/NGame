...
namespace NClient.OSS
{
    ...
    public class LifecycleRule : IEquatable<LifecycleRule>
    {
        ...
        /// <summary>
        /// Determines whether the specified <see cref="NClient.OSS.LifecycleRule"/> is equal to the current <see cref="T:Aliyun.OSS.LifecycleRule"/>.
        /// </summary>
        /// <param name="obj">The <see cref="NClient.OSS.LifecycleRule"/> to compare with the current <see cref="T:Aliyun.OSS.LifecycleRule"/>.</param>
        /// <returns><c>true</c> if the specified <see cref="NClient.OSS.LifecycleRule"/> is equal to the current
        ...
        public class LifeCycleTransition : IEquatable<LifeCycleTransition>
        {
            ...
            /// <summary>
            /// Determines whether the specified <see cref="NClient.OSS.LifecycleRule.LifeCycleTransition"/> is equal to
            /// the current <see cref="T:Aliyun.OSS.LifecycleRule.LifeCycleTransition"/>.
            /// </summary>
            /// <param name="transition">The <see cref="NClient.OSS.LifecycleRule.LifeCycleTransition"/> to compare with the current <see cref="T:Aliyun.OSS.LifecycleRule.LifeCycleTransition"/>.</param>
            /// <returns><c>true</c> if the specified <see cref="NClient.OSS.LifecycleRule.LifeCycleTransition"/> is equal to the
